  ...
  <div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  @endphp
                  <p style="font-weight:bold; text-align: center; font-size: 20px" >{{$student}}</p>
                </div>
            ...
            <div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  @endphp
                  <p style="font-weight:bold; text-align: center; font-size: 20px">{{$teacher}}</p>
                </div>
                <div class="dashboard-chart-card-container">
            ...
            <div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <p style="font-weight:bold; text-align: center; font-size: 20px" >Monthly: 2500 tk</p>
                </div>
                <div class="dashboard-chart-card-container">
            ...
            <div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <p style="font-weight:bold; text-align: center; font-size: 20px" >Revenue</p>
                </div>
                <div class="dashboard-chart-card-container">
          ...
          <div class="row">
                ...
                <div class="col-12 grid-margin d-flex align-items-stretch">
                  <div class="row">
                    <div class="col-12 col-sm-6 col-md-12 mb-3">
                      <div class="social-panel bg-facebook"></i><p class="mb-0">Computer & Sceince Engineer</p></div>
                    </div>
                    <!-- <div class="col-12 col-sm-6 col-md-12 mb-3">
                      <div class="social-panel bg-twitter"><p class="mb-0">Electronic & Electrical Engineer</p></div>
                    </div> -->
                    <div class="col-12 col-sm-6 col-md-12 mb-3">
                      <div class="social-panel bg-google"><p class="mb-0">Bachelor of Business Administration</p></div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-12">
                      <div class="social-panel bg-linkedin"><p class="mb-0">Master of Business Administration</p></div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-4 grid-margin d-flex align-items-stretch">
              <div class="card task-list w-100">
                <div class="card-body">
                  <h2 class="card-title">Sit Reminding</h2>
