      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p class="user-name">Abdul Goni</p>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('bba')}}">MBA</a>
                  </li>
           ...
           <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#layoutsSubmenu2">
                <i class="mdi mdi-arrow-expand-all menu-icon"></i>
  ...
  <script> 
    $(function() {
            $(document).on("click","#delete", function(e){
              ...
              bootbox.confirm("Are You Want You delete!!", function(confirmed){
              if (confirmed) {
